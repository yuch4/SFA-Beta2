...
import { PurchaseOrderHistory } from '../../types/purchase-order';

interface PurchaseOrderRevisionHistoryProps {
  history: PurchaseOrderHistory[];
}

const PurchaseOrderRevisionHistory: React.FC<PurchaseOrderRevisionHistoryProps> = ({ history }) => {
  const groupedHistory = history.reduce((acc, item) => {
    ...
    return acc;
  }, {} as Record<number, PurchaseOrderHistory[]>);
...
export default PurchaseOrderRevisionHistory;