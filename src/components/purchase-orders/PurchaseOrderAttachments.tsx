...
const PurchaseOrderAttachments: React.FC<PurchaseOrderAttachmentsProps> = ({
  poId,
  attachments,
  onAttachmentsChange,
}) => {
  const handleFileUpload = useCallback(async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    for (const file of Array.from(files)) {
      ...
      try {
        const filePath = `purchase-orders/${poId}/${crypto.randomUUID()}-${file.name}`;
  ...
  }, [poId, attachments, onAttachmentsChange]);
